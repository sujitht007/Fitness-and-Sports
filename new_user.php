		...
		<div class="card-body">
			<form action="" id="manage_user">
					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								...
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Trainer</option>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'run.php?page=user_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('run.php?page=user_list')
					},750)
				}else if(resp == 2){
